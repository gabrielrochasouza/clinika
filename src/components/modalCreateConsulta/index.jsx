...
const ModalCreateConsulta = () => {
  ...
  const { createConsulta, getConsultas } = useConsulta();
  ...
  const onSubmit = async (data) => {
    ...
    const res = await createHorario({
      dia_da_consulta: data.dia_da_consulta.split("-").reverse().join("-"),
                  ...
                  pacientes.map((paciente) => (
                    <li
                      ...
                      onClick={() => {
                        ...
                        document.getElementById("paciente-search-input").value =
                          paciente.nome;
                      }}>
                      {paciente.nome}
                    </li>
