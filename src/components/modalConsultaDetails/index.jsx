            ...
            <Modal
                ...
                bodyContent={
                    <form>
                        ...
                        <p>
                            Horário da consulta:{" "}
                            {consultaInfo.agenda.horario_inicial} -{" "}
                            {consultaInfo.agenda.horario_final}{" "}
                        </p>
                        <p>
                            Dia da consulta:{" "}
                            {consultaInfo.agenda.dia_da_consulta}
                        </p>
                        ...
                        <div>
                            <p
                                ...
                                Compareceu:{" "}
                                {consultaInfo.compareceu ? "Sim" : "Não"}{" "}
                            </p>
                            <p
                                onClick={async () => {
                                    await patchConsulta(
                        ...
                        <div>
                            <p
                                ...
                                Confirmado:{" "}
                                {consultaInfo.confirmado ? "Sim" : "Não"}
                            </p>
                            <p
                                onClick={async () => {
                                    await patchConsulta(
                        ...
                        <p className='undelineColored'>
                            Ver mais sobre o paciente
                        </p>
                        ...
                        <p>
                            Especialidade: {consultaInfo.medico.especialidade}
                        </p>
                        <p>
